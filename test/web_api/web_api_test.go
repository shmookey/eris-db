...
import (
	...
	"github.com/shmookey/eris-db/Godeps/_workspace/src/github.com/stretchr/testify/suite"
	...
	"github.com/shmookey/eris-db/rpc"
	"github.com/shmookey/eris-db/server"
	td "github.com/shmookey/eris-db/test/testdata/testdata"
	"io/ioutil"
	"net/http"
	"os"
	"path"
